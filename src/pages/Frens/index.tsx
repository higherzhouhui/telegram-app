...
I've found a platform where you can launch your meme coins. Check out your Telegram profile and claim your HAMSTER rewards🎁 now!👆🏻 ❤️
  ...
  return <div className="friends fadeIn">
    <div className="friends-title">
      <div>𝙸𝚗𝚟𝚒𝚝𝚎 𝙵𝚛𝚎𝚗𝚜</div>
      <div>𝚊𝚗𝚍 𝚐𝚎𝚝 𝚖𝚘𝚛𝚎 $𝙷𝙼𝚂𝚃𝚁</div>
    </div>
    <div className="logo">
    ...
    <div className="friends-list-wrapper">
      ...
      {
        !total ? <div className="tap-desc">𝘛𝘢𝘱 𝘰𝘯 𝘵𝘩𝘦 𝘣𝘶𝘵𝘵𝘰𝘯 𝘵𝘰 𝘪𝘯𝘷𝘪𝘵𝘦 𝘺𝘰𝘶𝘳 𝘧𝘳𝘪𝘦𝘯𝘥𝘴</div> : <div className="friends-list-title">
