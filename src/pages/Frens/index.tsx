...
function FrensPage() {
  ...
  return <div className='frens-page fadeIn'>
    ...
    <div className='page-bottom'>
      {
        isH5PcRoot ? <div className='invite-link'>{link}</div> : <Button color="default" style={{ fontWeight: 'bold', height: '50px', borderRadius: '100px', flex: 1, background: 'var(--btnBg)', color: '#000', border: 'none' }} onClick={() => handleShare()}>👆🏻 Invite frens</Button>
      }
