...
function WalletPage() {
  ...
  const [selfIsConnected, setSelfIsConnected] = useState(isConnected)
    ...
    <div className='connect-wrapper'>
      <img src="/assets/money.png" alt="wallet" width={32} />
      {
        isH5PcRoot ?
              ...
              <div className='connect-list'>
                {
                  walletType == 'PortkeyAA' ? <>
                    <div className='my-assets lock' onClick={lock}>
                      {isLocking ? 'unLock' : 'Lock'}
                    </div>
                    <div className='my-assets disconnect' onClick={async () => await disConnectWallet()}>
                      Disconnect
                    </div>
                  </> : <div className='my-assets disconnect' onClick={async () => await disConnectWallet()}>
                    Disconnect
                ...
                {
                  walletType == "PortkeyAA" ? <div className='my-assets assets' onClick={() => handleAsset()}>
                    Assets
          ...
          </div> : userInfo?.wallet && selfIsConnected ? <div>
            <div className='connect-desc'>The best Wallet to Explore AELF Ecosystem</div>
            <div className='connect-assets'>
              <div className='my-assets' onClick={() => handleCopyLink(userInfo.wallet, 'The address has been copied to the clipboard.')}>
                {formatWalletAddress(userInfo.wallet)}
