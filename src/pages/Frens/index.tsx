...
function FrensPage() {
  ...
  return <div className='frens-page fadeIn'>
    ...
    <div className='page-bottom'>
      <Button color="default" style={{ fontWeight: 'bold', borderRadius: '100px', flex: 1, background: '#000', color: 'var(--highColor)' }} onClick={() => handleShare()}>👆🏻 Invite frens</Button>
      <Button color="default" className="copy" onClick={() => copy()} style={{ borderRadius: '20px' }}>
        {
